...
contract InvestorRegister {
    ...
    function createInvestorRecord (string transcationContact,string investmentDate, uint investmentAmount, string investerInfoDoc, string purchaseAgreement, string promisoryNote, string w_9, string questionnare) {   
   ...
   function getTotal() public constant returns (uint, uint) {
       return (
       totalAmount,
